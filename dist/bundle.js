...
/******/ 	var hotCurrentHash = "8014bee102cd9a3e73e7"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	console.log(_typing2.default); //require('smoothscroll-polyfill').polyfill()
...
/***/ (function(module, exports, __webpack_require__) {
	...
	;(function(){
	  ...
	  if ('number' == typeof $$obj.length) {
	      for (var index = 0, $$l = $$obj.length; index < $$l; index++) {
	        var tag = $$obj[index];
	pug_html = pug_html + "\u003Clabel" + (pug.attr("for", 'id'+index, true, true)) + "\u003E\u003Cinput" + (" type=\"radio\" name=\"xx\""+pug.attr("id", 'id'+index, true, true)) + "\u003E\u003Cdiv" + (" id=\"but\""+pug.attr("data-filter", '.'+index, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = tag) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Flabel\u003E";
	      }
	  } else {
	    var $$l = 0;
	...
	pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv id=\"project-list-abstract\"\u003E" + (pug.escape(null == (pug_interp = project.abstract) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
	      }
	  } else {
	    var $$l = 0;
	...
	;(function(){
	  ...
	  if ('number' == typeof $$obj.length) {
	      for (var friend = 0, $$l = $$obj.length; friend < $$l; friend++) {
	        var link = $$obj[friend];
	pug_html = pug_html + "\u003Ca" + (" class=\"friend\""+pug.attr("href", link, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = friend) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
	      }
	  } else {
	    var $$l = 0;
	    for (var friend in $$obj) {
	      $$l++;
	      var link = $$obj[friend];
	pug_html = pug_html + "\u003Ca" + (" class=\"friend\""+pug.attr("href", link, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = friend) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
	    }
...
/***/ (function(module, exports) {
	...
	module.exports = {"name":"April","title":"APRIL WANG","subtitle":"I study human computer interaction.","character":"./assets/april.svg","menu":["ABOUT","PROJECT","MORE","CONTACT"],"content":[{"name":"APRIL WANG233","education":"MSc in HCI","affiliation":"Simon Fraser University","location":"TASC-8201","meat":[{"h":"About Me","p":"Hi, I'm <strong>April Wang</strong>, aka <strong>王奕</strong>. I am a <strong>thesis-based MSc student</strong> in the Human-Computer Interaction Lab at the School of Computing Science, <strong>Simon Fraser University</strong>, advised by <a href='http://hci.cs.sfu.ca/'>Dr.Chilana</a>. My research interests focus on <strong>using HCI techniques to lower the learning barriers for people without professional knowledge in a particular subject</strong>. <br><br> Before starting my journey in HCI research, I finished my Bachelor's degree in College of Computer Science and Technology, <strong>Zhejiang Univerisity</strong>, China. With a major in <strong>Digital Media and Network Technology</strong>, I received interdisciplinary training in multimedia processing, game engineering and human interface design. In addition, I have previously worked in <strong>Intel</strong> and <strong>Alibaba</strong> as a <strong>User Experience Design Intern</strong>, and <strong>NetEase Games</strong> as a <strong>Junior Software Developer</strong>."},{"h":"Publications","p":"<strong>PACM-CSCW 2017</strong>: Vermette, L., Dembla, S., Wang, A., McGrenere, J., & Chilana, P. 2017. Social CheatSheet: An Interactive Community-Curated Information Overlay for Web Applications. Proceedings of the ACM : Human-Computer Interaction (1,1), Computer-Supported Cooperative Work and Social Computing (CSCW) [to appear]."},{"h":"Conference Posters","p":"<strong>ICER 2017</strong>: Wang, A., & Chilana, P. 2017. Investigating Learning Strategies of Conversational Programmers. ACM Conference on International Computing Education Research (ICER), Tacoma, WA, August 2017 [conference poster]."}],"mail":"<a href='mailto:hi@aprilwang.me'>hi@aprilwang.me</a>","link":"Download CV"},{"projecttag":{"uxd":"#UX Design","eup":"#End-User Programming","b":"categoryB"},"project":[{"name":"IoT Services Orchestration Layer","tag":["uxd","eup"],"abstract":"A visual graphical programming solution for developing IoT applications.","album":"../assets/IoT-album.jpg"},{"name":"IoT Services Orchestration Layer","tag":["uxd","eup"],"abstract":"A visual graphical programming solution for developing IoT applications.","album":"../assets/IoT-album.jpg"},{"name":"IoT Services Orchestration Layer","tag":["uxd","eup"],"abstract":"A visual graphical programming solution for developing IoT applications.","album":"../assets/IoT-album.jpg"},{"name":"IoT Services Orchestration Layer","tag":["uxd","eup"],"abstract":"A visual graphical programming solution for developing IoT applications.","album":"../assets/IoT-album.jpg"},{"name":"IoT Services Orchestration Layer","tag":["uxd"],"abstract":"Designing the user interface for a visual graphical programming solution for developing IoT applications through drag-and-drop.","album":"../assets/IoT-album.jpg"},{"name":"IoT Services Orchestration Layer","tag":["b"],"abstract":"Designing the user interface for a visual graphical programming solution for developing IoT applications through drag-and-drop.","album":"../assets/IoT-album.jpg"},{"name":"IoT Services Orchestration Layer","tag":["eup"],"abstract":"Designing the user interface for a visual graphical programming solution for developing IoT applications through drag-and-drop.","album":"../assets/IoT-album.jpg"}]},{"h":"03 MORE","friends":{"Leo":"http://hi.leeleo.me/","Richard":"https://blog.hlyue.com/","Qusic":"https://qusic.me/","Robert":"https://blog.robotshell.org/","Senorsen":"https://www.senorsen.com/","XXJ":"https://itsxcy.net/"}}]}

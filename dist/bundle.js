...
/******/ 	var hotCurrentHash = "2798e56791f5ac634221"; // eslint-disable-line no-unused-vars
	...
	;(function(){
	  ...
	  if ('number' == typeof $$obj.length) {
	      for (var friend = 0, $$l = $$obj.length; friend < $$l; friend++) {
	        var link = $$obj[friend];
	pug_html = pug_html + "\u003Ca" + (" class=\"friend\""+pug.attr("href", link, true, true)+" target=\"_blank\"") + "\u003E" + (pug.escape(null == (pug_interp = friend) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
	      }
	  } else {
	    var $$l = 0;
